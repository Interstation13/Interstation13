...
/obj/item/card/id/prisoner/examine(mob/user)
	...
	if(sentence <= 0)
		to_chat(user, "<span class='notice'>You are serving a permanent sentence for [crime].</span>")
	else if(served >= (sentence * 60))
		to_chat(user, "<span class='notice'>You have served your sentence for [crime].</span>")
	else
		to_chat(user, "<span class='notice'>You have served [minutesServed] minutes [secondsServed] seconds of your [sentence] minute sentance for [crime].</span>")
	if(goal > 0)
