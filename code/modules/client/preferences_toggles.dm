...
TOGGLE_CHECKBOX(/datum/verbs/menu/Settings, listen_looc)()
	...
	SSblackbox.record_feedback("nested tally", "preferences_verb", 1, list("Toggle LOOC", "[GLOB.looc_allowed ? "Enabled" : "Disabled"]")) //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
