...
/mob/living/carbon/throw_item(atom/target)
	...
	if(thrown_thing)
		...
		thrown_thing.safe_throw_at(target, thrown_thing.throw_range, thrown_thing.throw_speed, src, null, null, null, move_force, spin = FALSE)//Spinning objects look dumb.
